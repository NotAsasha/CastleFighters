...
namespace Assets.Plugins.PreviewGenerator.Scripts
{
    [Serializable]
    ...
    public class PreviewGenerator
    {
        ...
        public GameObject GetInternalCamera()
        {
            ...
            if (PreviewCamera != null)
            {
                ...
                RuntimePreviewGenerator.RuntimePreviewGenerator.PreviewRenderCamera = cameraComponent;
        ...
        public void RenderPreviewTexture()
        {
            ...
            if (BackgroundColorOrTextureInfo.backType == BackgroundTextureTypes.Texture)
            {
                RuntimePreviewGenerator.RuntimePreviewGenerator.TransparentBackground = true;
                backgroundTexture = BackgroundColorOrTextureInfo.BackgroundTexture;
            }
            else
            {
                RuntimePreviewGenerator.RuntimePreviewGenerator.TransparentBackground = (BackgroundColorOrTextureInfo.backType == BackgroundTextureTypes.Transparent);
                RuntimePreviewGenerator.RuntimePreviewGenerator.BackgroundColor = BackgroundColorOrTextureInfo.BackgroundColor;
            }

            RuntimePreviewGenerator.RuntimePreviewGenerator.OrthographicMode = OrthographicCamera;
            ...
            if (GameObjectToRender != null)
            {
                ...
                RuntimePreviewGenerator.RuntimePreviewGenerator.PreviewDirection = ViewDirection;
                RuntimePreviewGenerator.RuntimePreviewGenerator.UpDirection = ViewUpDirection;
                RuntimePreviewGenerator.RuntimePreviewGenerator.PanOffset = PanOffset;
                RuntimePreviewGenerator.RuntimePreviewGenerator.ZoomLevel = ZoomLevel;
                Texture2D alphaTexture = null;


                Texture2D tempTexture =
                    RuntimePreviewGenerator.RuntimePreviewGenerator.GenerateModelPreview(tempGameObject.transform, RenderWidth, RenderHeight);
