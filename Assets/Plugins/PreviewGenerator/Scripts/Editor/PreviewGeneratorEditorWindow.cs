...
namespace Assets.Plugins.PreviewGenerator.Scripts.Editor
{
    ...
    public class PreviewGeneratorEditorWindow : EditorWindow
    {
        ...
        private UnityEditor.Editor _previewGeneratorEditor;
...
// these are for the Preview Generator script
    ...
    public class PreviewGeneratorEditor : UnityEditor.Editor
    {
